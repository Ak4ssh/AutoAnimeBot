...
async def _(event): 
    if not event.is_private:
        try:
            ...
            if event.photo:
                photo = event.media.photo
                await anibot.send_file(-1001791685690,-1001739244523,
                                    photo, 
                                    caption = event.text, 
                                    link_preview = False, 
                                    buttons=[
           ...
           Button.url("• Support •", "https://t.me/AutoAnimeUploads")
                ...
                try:
                    if event.media.webpage:
                        await anibot.send_message(-1001791685690,-1001739244523,
                                               event.text,
                                               link_preview = False, 
                                               buttons=[
           [
           ...
           Button.url("• Support •", "https://t.me/AutoAnimeUploads")
                ...
                await anibot.send_message(-1001791685690,-1001739244523, event.text, link_preview = False, buttons=btn)
        except:
            print("TO_CHANNEL ID is wrong or I can't send messages there (make me admin).")
